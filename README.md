...
```
cd existing_repo
git remote add origin https://csgitlab.reading.ac.uk/sv012194/fyp-victoria-chan.git
git branch -M main
...
- [ ] [Set up project integrations](https://csgitlab.reading.ac.uk/sv012194/fyp-victoria-chan/-/settings/integrations)
